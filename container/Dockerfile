...
#Clone the newest version of the workshop
RUN git clone https://github.com/diningbyfriends/2020-01-AustinWorkshop.git /home/project/.

# Add Data to Gremlin Server
COPY ./data/* /opt/data/
RUN sudo chmod 777 /opt/data/
